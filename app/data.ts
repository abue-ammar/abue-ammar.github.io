...
export const skills = {
  ...
  skills: [
    ...
    },
    {
      ...
      url: "https://avatars.githubusercontent.com/u/20658825?s=48&v=4",
    },
    {
      name: "Git",
  ...
  companies: [
    {
      ...
      tasks: [
        "Frontend development with ReactJS, NextJS, Redux Toolkit, Ant Design and Tailwind CSS.",
        "Developing responsive web app and lightweight PWA.",
        "Work in agile environment to ship features quickly.",
      ],
    },
  ],
};
